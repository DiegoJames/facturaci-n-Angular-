...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-08-2016 a las 17:34:40
...
--
CREATE DATABASE IF NOT EXISTS `facturacion_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `facturacion_db`;
...
(201, 'Gabriel garcia', 'gg@gmail.com', '', '', '', '', ''),
(202, 'Diego Orellana', 'dao@hotmail.com', '', '', '', 'Costa Rica', ''),
(203, 'juan perez herrera', 'jp@hotmail.com', '', '', '', '', ''),
(204, 'sada', 'as@hotmail.cl', '', '', '', '', '');
...
(1, 'FERNANDO', 'fernando herrera', '$2a$07$73/H2.AKJEHE.ACIHJBIK.LeBzSTezd28.OP6UgyaHpeT7XZ/FP72', '2016-08-14 11:33:42');
